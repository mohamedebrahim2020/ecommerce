                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <center> <input type="text" class="form-control w-50" id="product"
                                                placeholder="enter product" name="product" value="{{ $product->name }}">
                                        </center>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <center> <input type="text" class="form-control w-50" id="product"
                                                ...
                                                value="{{ $product->description }}"></center>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <center> <input type="number" class="form-control w-50" id="product"
                                                ...
                                                value="{{ $product->quantity }}"></center>
                                    </div>
                                    <div class="form-group">
                                        <label for="category">product price:</label>
                                        <center> <input type="number" class="form-control w-50" id="product"
                                                placeholder="enter product" name="price" value="{{ $product->price }}">
                                        </center>
                                    </div>
                                    <div class="form-group">
                                        <label for="category">product image:</label>
                                        <center> <input type="file" class="form-control w-50" id="product"
                                                placeholder="enter product" name="image"
                                                value="{{ url('storage/' . $product->image) }}" required></center>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                @if ($offer->id == $product->offer_id)
                                                    <div class="col-md-3">
                                                        <center> <input type="radio" class="form-control w-50"
                                                                ...
                                                                checked="checked">{{ $offer->offer_percentage }}</center>
                                                    </div>
                                                @else
                                                    <div class="col-md-3">
                                                        <center> <input type="radio" class="form-control w-50"
                                                                id="{{ $offer->id }}" placeholder="enter product"
                                                                name="offer_id"
                                                                value="{{ $offer->id }}">{{ $offer->offer_percentage }}
                                                        </center>
                                                    </div>
                                                @endif
                                            @endforeach
                                                ...
                                                @if ($category->id == $product->category_id)
                                                    <div class="col-md-3">
                                                        <center> <input type="radio" class="form-control w-50"
                                                                ...
                                                                checked="checked">{{ $category->name }}</center>
                                                    </div>
                                                @else
                                                    <div class="col-md-3">
                                                        <center> <input type="radio" class="form-control w-50"
