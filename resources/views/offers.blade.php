                    ...
                    <div class="section-title">
                        ...
                        <div class="section-nav">
                            <ul class="section-tab-nav tab-nav">
                                <li class="active dd" style="float: left;" value="5"><a data-toggle="tab"
                                        href="#tab2">All</a></li>
                                        ...
                                        <div class="col-md-3">
                                            <div class="product">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h4 class="product-price">${{ $product->finalPrice() }}<del
                                                    ...
                                                    <div class="product-btns">
                                                        <button class="add-to-wishlist"><i class="fa fa-heart seller"
                                                                id="a{{ $product->id }}"
                                                                style="font-size:15px;color:{{ $product->checkHeart() }};"></i><span
                                                                class="tooltipp"
                                                                id="d{{ $product->id }}">{{ $product->checkWordHeart() }}</span></button>
                                                ...
                                                <div class="add-to-cart">
                                                    <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>
                                                        <div class="mydiv" id="{{ $product->id }}">
                                                            {{ $product->checkInCart() }}</div>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    <div class="col-md-12 text-center justify-content-center"> {{ $products->links() }}
                                    </div>
                                </div>
                                <!-- /product -->
                            </div>
