                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group-append">
                                  <button class="btn btn-primary" id="code">Apply</button>
                                </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>$</span><span><?php echo (Cart::instance('main')->priceTotal()); ?></span></div>
                                </div>
                                <div class="col-xs-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button  class="btn btn-primary btn-submit-fix">Place Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
