    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h3 class="title">Category:- {{$selectedCategory->name}}</h3>
           ...
           <div class="product">
             ...
             <div class="product-body">
               ...
               <div class="product-btns">
                 ...
                 <button class="quick-view"><a href="/products/{{$product->id}}"><i class="fa fa-eye"></i><span class="tooltipp">view product</span></a></button>
               </div>
             </div>
...
function activeSelect(backID) {
  var code = "cat";
  var id = code.concat(backID)
...
function attachCart(data){
    ...
    $(document).ready(function () {
      var sites = {!! json_encode($selectedCategory->id, JSON_HEX_TAG) !!};
          activeSelect(sites);     
