...
@section('content')
    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h4 class="text-center">Articles and news</h4>
                <hr>
                <div class="form-group">
                    <label>Type a tag name</label>
                    <input type="text" name="country" id="country" placeholder="Enter a new tag name" class="form-control">
                </div>
    ...
    `)
      ...
      <img src="{{ url('storage/${element.image}') }}" class="card-img-top " style=" height: 400px;
      width: 700px;" alt="...">
      <div class="card-body">
        <h5 class="card-title">${element.name}</h5>
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        <a href="/people/details/${element.id}" class="btn btn-primary">Go somewhere</a>
      </div>
    </div>
    <hr>
     `)
